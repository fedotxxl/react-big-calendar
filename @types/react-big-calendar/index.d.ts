declare module '@fedotxxl/react-big-calendar' {
...
// TypeScript Version: 2.8
    ...
    export type ViewProps<TEvent extends object = Event, TResource extends object = object> =
        Omit<CalendarProps<TEvent, TResource>,
    ...
    export type ResourceWeekViewHeader = 'day' | 'resource';
    ...
    export interface CalendarProps<TEvent extends object = Event, TResource extends object = object> {
        ...
        allDayHidden?: boolean | undefined;
        ...
        resourceWeekViewHeader?: ResourceWeekViewHeader;
    ...
    export class Calendar<TEvent extends object = Event,
        TResource extends object = object> extends React.Component<CalendarProps<TEvent, TResource>> {
    }
    ...
    export class TimeGrid<TEvent extends object = Event, TResource extends object = object> extends React.Component<TimeGridProps<TEvent, TResource>> {
    }
...
declare module '@fedotxxl/react-big-calendar/lib/addons/dragAndDrop' {
    import * as React from 'react';
    import { stringOrDate, Components, CalendarProps } from '@fedotxxl/react-big-calendar';
    ...
    export class DragAndDropCalendar<TEvent extends object = Event, TResource extends object = object>
        extends React.Component<DragAndDropCalendarProps<TEvent, TResource>> {
    }

    export function withDragAndDrop<TEvent extends object = Event, TResource extends object = object>(
